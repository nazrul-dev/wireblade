...
class Dialog extends Actionable
{
    ...
    {
        $this->component->dispatchBrowserEvent("wireblade:{$this::makeEventName($this->id)}", [
            'options'     => $options,
    ...
    public function confirm(array $options): self
    {
        ...
        $this->component->dispatchBrowserEvent("wireblade:confirm-{$this::makeEventName($this->id)}", [
            'options'     => $options,
            'componentId' => $this->component->id,
        ]);
